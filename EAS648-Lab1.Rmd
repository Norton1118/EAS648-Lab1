...
This report uses open science principles to analyze spatial patterns in Boulder’s Open Space and Mountain Parks (OSMP) through social media photo data. Utilizing R, R Markdown, and Git for version control, the analysis explores how landscape elevation and accessibility affect where people take and share photos. The workflow details each step, from data import to visualization and user behavior comparison across platforms. Results are showcased with a map and box plot, highlighting transparency and reproducibility in geospatial data.
...
![Git history screenshot](Screenshot 2025-10-27 132836.png)
